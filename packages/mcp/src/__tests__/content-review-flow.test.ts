/**
 * Integration tests for the /content-review internal endpoints.
 * (Legacy /ingest-document gate tests removed with the endpoint — l37i;
 *  the spam gate is now covered via /publish-document + spam-screen units.)
