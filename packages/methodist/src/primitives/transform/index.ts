...
import { redactFieldsPrimitive } from './redact-fields.js';
...
export function transformPrimitives(assignId: AssignId): Registration[] {
  return [canonicalizePrimitive, computeHashPrimitive, makeResolveLocalIds(assignId), redactFieldsPrimitive];
}
